...
This file lists third-party source code adapted into this repository, its
provenance, and what changed from upstream. The full Apache License, Version
2.0 text (which governs everything below) follows the provenance sections.
