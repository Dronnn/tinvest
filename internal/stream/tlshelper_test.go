...
// authority and returns matching server and client TLS credentials. The stream
// tests dial bufconn over TLS because the per-RPC token credentials require
// transport security (there is no plaintext seam for a bearer token).
